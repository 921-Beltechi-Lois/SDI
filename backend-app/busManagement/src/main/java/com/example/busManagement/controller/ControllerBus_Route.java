...
//    @GetMapping("/busroutes/count/higherThanGivenDistance/{distance}")
//    public long getBusRoutesCountHigherThanGivenDistance(@PathVariable int distance) {
//        return busRouteService.countByDistanceGreaterThan(distance);
//    }
